...
class CI_Image_lib {
    ...
    function image_process_gd($action = 'resize') {
        ...
        // INSERIDO POR MÁRIO CÉSAR 10-10-2013
        // keep transparency
        ...
        } elseif ($this->image_type == 3 || $this->image_type == IMAGETYPE_WEBP ) {
        ...
        if ($this->image_type == 3 || $this->image_type == IMAGETYPE_WEBP ) { // png we can actually preserve transparency
            imagealphablending($dst_img, FALSE);
            imagesavealpha($dst_img, TRUE);
        }
        //FIM NOVO CODIGO
    ...
    function image_display_gd($resource) {
        ...
        switch ($this->image_type) {
            ...
            case 3 : imagepng($resource);
                break;
            case IMAGETYPE_WEBP  : imagewebp($resource, null, $this->quality);
                break;

...
class CI_Security {
    ...
    public function csrf_verify() {
        ...
        if (!isset($_POST[$this->_csrf_token_name]) && isset($headers['x-csrf-token'])) {
            $_POST[$this->_csrf_token_name] = $headers['x-csrf-token'];
        }
    ...
    public function csrf_set_cookie() {
        ...
        setcookie($this->_csrf_cookie_name, $this->_csrf_hash, $expire, config_item('cookie_path'), config_item('cookie_domain'), $secure_cookie, config_item('cookie_http_only') ?: false);
    ...
    public function csrf_show_error() {
        throw new Exception('CSRF', 987651);
    }
